...
define('dust/core',[],function () {
  ...
  dust.loadFn = function (fn) {
    return function(context, callback) {
      var master = callback ? new Stub(callback) : new Stream();
      dust.nextTick(function() {
        fn(master.head, Context.wrap(context)).end();
      });
      return master;
    }      
  };
...
/*global define:true */
/*jshint white:false latedef:false laxbreak:true forin:false */



define('dust/compiler',[], function () {

  return function(dust) { // this augments dust with compiler functionality
    ...
    dust.nodes = {
      ...
      "%": function(context, node) {
        ...
        var params = {};
        for (var j=1, lenp=rawParams.length; j<lenp; j++) {
          var p = rawParams[j];
          params[p[1][1]] = p[2][1];
        }
...
define('dust',['./core', './compiler', './parser'],
